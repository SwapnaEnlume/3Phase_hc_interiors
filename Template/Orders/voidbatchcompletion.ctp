<!-- src/Template/Orders/voidbatchcompletion.ctp -->
<style>
...
<h2>Are you sure you want to VOID this Completion entry?</h2>
<h3>This will reset the batch to <u>Scheduled + Not Completed</u></h3>
