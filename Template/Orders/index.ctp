...
<h1 class="pageheading">Sales Orders</h1>

<button type="button" id="newquickorder" onclick="location.href='/orders/addnew/';">+ New Sales Order</button>
...
$rowcols='<th rowspan="2">Actions</th>
	...
	<th rowspan="2">Recipient / Type</th>
	...
	$('#orderstatustabs ul li').each(function(){
			...
			dtArray[thistab]=$('#'+thistab+'-ordersList').DataTable({
				...
				"columns": [
					...
					{"className":"company","orderable":true},
