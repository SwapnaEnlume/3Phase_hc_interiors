...
if($scope == 'scope')
echo "<span width=\"100%\" valign=\"top\" align=\"center\"><b> INSTALL SCOPE</b></span>";
echo "<br><br>";
...
<th width=\"15%\" style=\"border-top:1px solid #000000; border-left:1px solid #CCC; font-size:7px;\" align=\"center\"><span style=\"font-size:7px;color:#FFF;\"><b>PRODUCT IMAGE</b></span></th>
...
<th width=\"8%\" style=\"border-top:1px solid #000000; border-left:1px solid #CCC; font-size:7px;\" align=\"center\"><span style=\"font-size:7px;color:#FFF;\"><b>FAB IMG</b></span></th>
<th width=\"22%\" style=\"border-top:1px solid #000000; border-left:1px solid #CCC; font-size:7px;\" colspan=\"2\" align=\"center\"><span style=\"font-size:7px;color:#FFF;\"><b>DIMENSIONS &amp; SPECS</b></span></th>";
if($scope !='scope'){
echo "<th width=\"6%\" valign=\"bottom\" align=\"center\" style=\"border-top:1px solid #000000; border-left:1px solid #CCC; font-size:7px;\"><span style=\"font-size:7px;color:#FFF;\"><b>PRICE EA</b></span></th>
...
if($item['internal_line'] == 0){
	...
	/* PPSASCRUM-56: start */
	if ($item['metadata']['calculator-used'] == "pinch-pleated" || $item['metadata']['calculator-used'] == "new-pinch-pleated") {
		echo ucfirst($item['metadata']['unit-of-measure']);
	} else {
	...
	switch($item['product_type']){
		...
		case "calculator":
			...
			switch($item['metadata']['calculator-used']){
                ...
                /* PPSASCRUM-384: end */
					switch ($item['metadata']['pleat_type']) {
						case "cartridge_pleat":
							$pleatTypeName = "Cartridge Pleat";
							break;
						case "single_pleat":
							$pleatTypeName = "Single Pleat";
							break;
						case "2_prong_pleat":
							$pleatTypeName = "2 Prong Pleat";
							break;
						case "3_prong_pleat":
							$pleatTypeName = "3 Prong Pleat";
							break;
						case "inverted_pleat":
							$pleatTypeName = "Inverted Pleat";
							break;
						case "goblet_pleat":
							$pleatTypeName = "Goblet Pleat";
							break;
						case "2_prong_euro_pleat":
							$pleatTypeName = "2 Prong Euro Pleat";
							break;
						case "3_prong_euro_pleat":
							$pleatTypeName = "3 Prong Euro Pleat";
							break;
						case "other":
							$pleatTypeName = "OTHER";
							break;
					...
					/* PPSASCRUM-305: start */
				    if ($item['metadata']['calculator-used'] == "new-pinch-pleated" || $item['metadata']['calculator-used'] == "pinch-pleated") {
					    echo "Pinch Pleated Drapery<br/>" . $pleatTypeName . "<br/>";
				    } else if ($item['metadata']['calculator-used'] == "ripplefold-drapery") {
				        echo "Ripplefold Drapery<br/>";
				    } /* PPSASCRUM-384: start */ else if ($item['metadata']['calculator-used'] == "accordiafold-drapery") {
				        echo "Accordiafold Drapery<br/><br/>";
				    } /* PPSASCRUM-384: end */
				    /* PPSASCRUM-305: end */
			    /* PPSASCRUM-56: end */
				...
				// 		echo "<br>".$item['metadata']['panel-type']." Panel";
						/* PPSASCRUM-384: start */
						echo "<br>".$item['metadata']['panel-type']." Panel - " . ucfirst($item['metadata']['draw']);
						/* PPSASCRUM-384: end */
						/* PPSASCRUM-56: end */
					}
				break;
        ...
        case 'newcatchall-valance':
            echo $item['title'];
            //echo "<br>(".$thisClass." / ".$thisSubClass.")";
	...
	echo "</span></td>
	<td width=\"15%\" align=\"center\" style=\"border-left:1px solid #000000; border-bottom:".$bottomborder."; font-size:7px;\" valign=\"top\">";

	switch($item['product_type']){
		case "track_systems":

			foreach($alltracksystems as $num => $tracksys){
				
				if($tracksys['id'] == $item['product_id']){
					
					echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/files/track-systems/".$item['product_id']."/".$tracksys['primary_image']."\" width=\"115\" />";
				}
			}
		...
		default:
			...
			if($item['product_type'] != 'services'){
				if(isset($item['metadata']['libraryimageid']) && $item['metadata']['libraryimageid'] != '0' && $item['metadata']['libraryimageid'] != ''){
					echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/img/library/".$allimages[$item['metadata']['libraryimageid']]['filename']."\" width=\"115\" />";
				}else{
			
					echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/img/noimage.png\" width=\"115\" />";
				}
			}
	...
	echo "</span></td>
	<td width=\"8%\" align=\"center\" style=\"border-left:1px solid #000000; border-bottom:".$bottomborder."; font-size:7px;\" valign=\"top\">";
	if($item['product_type'] != 'track_systems' && $item['product_type'] != 'services'){
		if(isset($item['fabricdata']['id'])){
			
			$imagetype=strtolower(substr($item['fabricdata']['image_file'],-4));
						
			switch($imagetype){
				case ".png":
					$newfile=$_SERVER['DOCUMENT_ROOT'].'webroot/files/fabrics/'.$item['fabricdata']['id'].'/'.str_replace('.png','-small.png',$item['fabricdata']['image_file']);
				break;
				case ".jpg":
					$newfile=$_SERVER['DOCUMENT_ROOT'].'webroot/files/fabrics/'.$item['fabricdata']['id'].'/'.str_replace('.jpg','-small.jpg',$item['fabricdata']['image_file']);
				break;
				case "jpeg";
					$newfile=$_SERVER['DOCUMENT_ROOT'].'webroot/files/fabrics/'.$item['fabricdata']['id'].'/'.str_replace('.jpeg','-small.jpg',$item['fabricdata']['image_file']);
				break;
				case ".gif":
					$newfile=$_SERVER['DOCUMENT_ROOT'].'webroot/files/fabrics/'.$item['fabricdata']['id'].'/'.str_replace('.gif','-small.gif',$item['fabricdata']['image_file']);
				break;
			}
			
			
			if(file_exists($newfile)){
				echo "<img src=\"".$newfile."\" width=\"40\" />";
			}else{
			    if(file_exists($_SERVER['DOCUMENT_ROOT']."webroot/files/fabrics/".$item['fabricdata']['id']."/".$item['fabricdata']['image_file'])){
				echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."webroot/files/fabrics/".$item['fabricdata']['id']."/".$item['fabricdata']['image_file']."\" width=\"40\" />";
			    }else{
			        echo "&nbsp;";
			        //echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."webroot/img/noimage.png\" width=\"40\" />";
			    }
			}
	...
	if($item['product_type'] == 'track_systems'){
		echo "<td width=\"22%\" colspan=\"2\" align=\"center\" style=\"border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:".$bottomborder."; font-size:7px;\" valign=\"top\"><span style=\"font-size:7px;\">";
		echo $item['title']."<br>".htmlspecialchars($item['description']);
		echo "</span></td>";
		...
		echo "<td width=\"8%\" align=\"center\" style=\"border-left:1px solid #000000; border-right:1px solid #000000; border-bottom:".$bottomborder."; font-size:7px;\" valign=\"top\"><span style=\"font-size:7px;\">";
...
// 		}elseif(($item['product_type']=="window_treatments" && $item['metadata']['wttype'] == 'Pinch Pleated Drapery') || ($item['metadata']['calculator-used']=='pinch-pleated') || ($item['metadata']['calculator-used']=='new-pinch-pleated')){
        ...
        /* PPSASCRUM-305: end */
			...
			if($item['metadata']['unit-of-measure'] == 'pair' || $item['metadata']['unit-of-measure'] == 'panel'){
		/* PPSASCRUM-56: end */
		...
		}elseif($item['product_type'] == 'newcatchall-hardware'){
		    
		    echo "Rod W: ".$item['metadata']['finished-width'];
		...
		echo "</span></td>
		<td width=\"14%\" align=\"center\" style=\"border-left:1px solid #CCCCCC; border-bottom:".$bottomborder."; font-size:7px;\" valign=\"top\"><span style=\"font-size:7px;\">";
        ...
        switch($item['product_type']){
            ...
            case 'newcatchall-cornice':
            case 'newcatchall-swtmisc':
                if(strlen(trim($item['metadata']['specs'])) > 0){
			...
			/* if (isset($item['metadata']['linings_id']) && !empty(strval($item['metadata']['linings_id']))) {
				$celloutput .= $alllinings[$item['metadata']['linings_id']]." Lining, ";
			} */
			/* PPSASCRUM-366: end */
			/* PPSASCRUM-359: end */
			/**PPSASCRUM-13 end **/
		...
		if($item['product_type'] == 'newcatchall-swtmisc' ){
		    if(isset($item['metadata']['linings_id']))
		        $celloutput .= $alllinings[$item['metadata']['linings_id']]." Lining, ";
		      if(isset($item['metadata']['return']))
		    	$celloutput .= $item['metadata']['return']."&quot; Return, ";
		}
		if($item['product_type'] == 'newcatchall-cornice'){
		        if(isset($item['metadata']['linings_id']))
                    $celloutput .= $alllinings[$item['metadata']['linings_id']]." Lining, ";
		    	if(isset($item['metadata']['return']))
		    	    $celloutput .= $item['metadata']['return']."&quot; Return, ";
		...
		if($item['product_type'] == 'newcatchall-valance'){
		    if(isset($item['metadata']['linings_id']))
		        $celloutput .= $alllinings[$item['metadata']['linings_id']]." Lining, ";
		   if(isset($item['metadata']['return']))
		        $celloutput .= $item['metadata']['return']."&quot; Return, ";
...
// 		if(($item['product_type'] == 'window_treatments' && $item['metadata']['wttype'] == "Pinch Pleated Drapery") || ($item['product_type']=="calculator" && ($item['metadata']['calculator-used']=='pinch-pleated' || $item['metadata']['calculator-used']=='new-pinch-pleated'))){
		...
		/* PPSASCRUM-56: end */
		    ...
		    /* PPSASCRUM-56: start */
			if($item['product_type']=="calculator" && ($item['metadata']['calculator-used']=='pinch-pleated' || $item['metadata']['calculator-used']=='new-pinch-pleated')) {
			/* PPSASCRUM-56: end */
			...
			/* PPSASCRUM-384: start */
			if ($item['product_type']=="calculator" && $item['metadata']['calculator-used'] == "accordiafold-drapery") {
			    $celloutput .= $item['metadata']["pleat_tape"] . "\" Pleat Tape, ";
			}
			/* PPSASCRUM-384: end */
	...
	/////////////////////	
		...
		if($item['metadata']['com-fabric'] == '1'){
		    echo "<br><b>COM ".$item['metadata']['yds-per-unit']." yds ea</b>";
		}
	...
	//if(floatval($item['extended_price']) >0){
	    if($item['override_active'] == 1){
		    echo "\$".number_format(floatval($item['override_price'] * $item['qty']),2,'.',',');
	    }else{
	        echo "\$".number_format(floatval($item['pmi_adjusted'] * $item['qty']),2,'.',',');
	    }
	//}else{
		//echo "---";
	//}
	...
	if(count($item['notes']) >0){
		...
		foreach($item['notes'] as $noteRow){
			if($noteRow['visible_to_customer'] == '1'){
				...
				<td colspan=\"9\" align=\"left\" style=\"border-left:1px solid #CCCCCC; border-right:1px solid #000000; border-bottom:1px solid ".$bottombordercolorcode.";font-size:6px;\">".nl2br(fixcharacters($noteRow['message']))."</td>
				</tr>";
			}
		}
...
//." @ ".date('n/j/y g:iA',$globalNote['time'])
		//global notes loop
		...
		if(count($COMFabricsTotals) > 0 && $scope != 'scope'){
			echo "<table width=\"100%\" cellpadding=\"4\" cellspacing=\"0\" border=\"0\">";
			echo "<tr><td><b>COM:</b></td><td></td></tr>";
			foreach($COMFabricsTotals as $fabrickey => $yardsnum){
				echo "<tr>
				<td>";
				if(is_numeric($fabrickey)){
					foreach($allFabrics as $fabricData){
						if($fabricData['id']==$fabrickey){
							echo $fabricData['fabric_name']." (".$fabricData['color'].')';
						}
					}
				}else{
					echo $fabrickey;
		...
		/* PPSASCRUM-369: end */
				...
				/*
				<td width=\"44%\" align=\"right\" style=\"border-bottom:1px solid #000000; border-right:1px solid #000000; border-left:1px solid #000000; color:#FFF; font-weight:bold; font-size:8px; text-align:right;\">\$".number_format($quoteData['quote_subtotal'],2,'.',',')."</td>
				if()
...
//if(count($quoteItems) > 1){
	echo "<br pagebreak=\"true\"/><br>";
//}

echo "<br>
<div style=\"font-size:8x;\">".nl2br($allSettings['quote_pdf_terms_content'])."</div>
<br>
<br>
...
<tr>
<td width=\"32%\" valign=\"bottom\"><img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/img/signatures/".$quoteAuthorData['signature_image']."\" width=\"105\" /></td>
<td width=\"23%\" valign=\"bottom\" align=\"center\">";
if($quoteData['status']=='draft'){
	if($quoteData['expires'] < time()){
		echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/img/pdf-expired.png\" width=\"75\" />";
	}else{
		echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/img/pdf-preview.png\" width=\"75\" />";
	}
}else{
	if($quoteData['expires'] < time()){
		echo "<img src=\"".$_SERVER['DOCUMENT_ROOT']."/webroot/img/pdf-expired.png\" width=\"75\" />";
...
<tr>
<td width=\"32%\" style=\"border-top:1px solid #000000\"><span style=\"font-size:10px;\">".$quoteAuthorData['first_name']." ".$quoteAuthorData['last_name'].", HC Interiors</span></td>
<td width=\"23%\">&nbsp;</td>
<td width=\"45%\" style=\"border-top:1px solid #000000\"><span style=\"font-size:10px;\">Authorization to Proceed&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Purchase Order</span></td>
</tr>
</table>";
