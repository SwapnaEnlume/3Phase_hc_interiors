...
if(count($globalNotes) >0){
	$globalNotesOutput .= "<b>GLOBAL NOTES:</b><table style=\"background:#f8f8f8 !important; width:100% !important;\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" bordercolor=\"#000066\">";

	foreach($globalNotes as $noteRow){
		$globalNotesOutput .= "<tr><td width=\"10%\" align=\"right\" valign=\"top\" style=\"font-size:12px;\">";
		...
		<td style=\"font-size:12px;\" valign=\"top\" align=\"left\" width=\"80%\">";
...
//CUBICLES BEGIN
	...
	<thead>
	<tr bgcolor=\"#111111\">
		<th width=\"3%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>LINE</b></span></th>
		<th width=\"8%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>LOCATION</b></span></th>
	...
	foreach($quoteItems as $itemid => $item){
		...
		if(!in_array($itemid,$usedLineIDs)){
			...
			if($item['product_type'] == 'cubicle_curtains' || ($item['product_type'] == 'calculator' && $item['metadata']['calculator-used'] == 'cubicle-curtain') || $item['product_type'] == 'newcatchall-cubicle'){
				...
				echo "<td width=\"3%\" style=\"text-align:center; font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['line_number']."</span></td>";
				echo "<td width=\"8%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['room_number']."</span></td>";
				...
				<td style=\"font-size:7px;\">".$item['room_number']."</td>
				...
				<td style=\"font-size:7px;\" colspan=\"5\">".$item['title']."</td>
				<td style=\"font-size:7px;\" colspan=\"12\">".$item['description']." (".(floatval($item['metadata']['yds-per-unit'])*floatval($item['qty']))." yards)</td>
				</tr>";
		...
		foreach($quoteItems as $subitemid => $subitem){
			...
			if($subitem['line_number'] == $item['line_number'] && $subitem['parent_line'] == 0 && $subitem['product_type'] == 'custom'){
				if(!in_array($subitemid,$usedLineIDs)){
					...
					<td style=\"font-size:7px;\">".$subitem['room_number']."</td>
					...
					<td style=\"font-size:7px;\" colspan=\"5\">".$subitem['title']."</td>
					<td style=\"font-size:7px;\" colspan=\"12\">".$subitem['description']." (".(floatval($subitem['metadata']['yds-per-unit'])*floatval($subitem['qty']))." yards)</td>
					</tr>";
...
$lastparent=0;
	...
	<tr bgcolor=\"#444444\">
		...
		<th width=\"3%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>QTY</b></span></th>
		<th width=\"6%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>FABRIC</b></span></th>
		<th width=\"7%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>COLOR</b></span></th>
	...
	foreach($quoteItems as $item){
		...
		if($item['product_type'] == 'bedspreads' || ($item['product_type'] == 'calculator' && ($item['metadata']['calculator-used'] == 'bedspread' || $item['metadata']['calculator-used'] == 'bedspread-manual')) || $item['product_type'] == 'newcatchall-bedding'){
			...
			echo "<tr bgcolor=\"".$bgcolor."\">";
			echo "<td width=\"3%\" style=\"font-size:7px; text-align:center;\"><span style=\"font-size:7px;color:#000000;\">".$item['line_number']."</span></td>";
			echo "<td width=\"5%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['room_number']."</span></td>";
			echo "<td width=\"3%\" style=\"font-size:7px; text-align:center;\"><span style=\"font-size:7px;color:#000000;\">".$item['qty']."</span></td>";
			echo "<td width=\"6%\" style=\"font-size:7px; text-align:center;\"><span style=\"font-size:7px;color:#000000;\">";
			...
			echo $item['fabricdata']['fabric_name']."</span></td>";
			echo "<td width=\"7%\" style=\"font-size:7px; text-align:center;\"><span style=\"font-size:7px;color:#000000;\">".$item['fabricdata']['color']."</span></td>";
			...
			<td style=\"font-size:7px; text-align:center\">".$item['room_number']."</td>
			...
			<td style=\"font-size:7px;\" colspan=\"4\">".$item['title']."</td>
			<td style=\"font-size:7px;\" colspan=\"20\">".$item['description']." (".(floatval($item['metadata']['yds-per-unit'])*floatval($item['qty']))." yards)</td>
			</tr>";
...
$lastparent=0;
	...
	<thead>
	<tr bgcolor=\"#111111\">
		<th width=\"4%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>LINE</b></span></th>
		<th width=\"8%\" rowspan=\"2\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>LOCATION</b></span></th>
	...
	foreach($quoteItems as $item){
		...
		if(($item['product_type'] == 'calculator' && $item['metadata']['calculator-used'] == 'straight-cornice') ||	$item['product_type'] == 'newcatchall-cornice'){
			...
			echo "<tr bgcolor=\"".$bgcolor."\">";
			echo "<td width=\"4%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['line_number']."</span></td>";
			echo "<td width=\"8%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['room_number']."</span></td>";
...
// 			if($item['metadata']['wttype'] == 'Pinch Pleated Drapery' || $item['metadata']['calculator-used'] == 'pinch-pleated' || $item['product_type'] == 'newcatchall-drapery' || $item['metadata']['calculator-used'] == 'new-pinch-pleated'){
		    if($item['metadata']['wttype'] == 'Pinch Pleated Drapery' || $item['metadata']['calculator-used'] == 'pinch-pleated' || $item['product_type'] == 'newcatchall-drapery' || $item['metadata']['calculator-used'] == 'new-pinch-pleated' || $item['metadata']['calculator-used'] == "ripplefold-drapery"){
			/* PPSASCRUM-305: end */
			/* PPSASCRUM-56: end */
			...
			foreach($quoteItems as $childitem){
				...
				if($childitem['parent_line'] == $item['primarykey']){
					...
					echo "<td width=\"8%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$childitem['room_number']."</span></td>";
					echo "<td width=\"4%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$childitem['qty']."</span></td>";
					echo "<td width=\"11%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">";
					//product type
					//echo "CUSTOM";
					//echo $childitem['metadata']['unit_type']." ";
					...
					echo "<td width=\"47%\" colspan=\"11\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$childitem['description']."</span></td>";
...
// 		if(($item['product_type'] == 'calculator' && ($item['metadata']['calculator-used'] == 'pinch-pleated' || $item['metadata']['calculator-used'] == 'pinch-pleated-new' || $item['metadata']['calculator-used'] == 'new-pinch-pleated')) || $item['product_type'] == 'newcatchall-drapery'){
	    if(($item['product_type'] == 'calculator' && ($item['metadata']['calculator-used'] == 'pinch-pleated' || $item['metadata']['calculator-used'] == 'pinch-pleated-new' || $item['metadata']['calculator-used'] == 'new-pinch-pleated' || $item['metadata']['calculator-used'] == "ripplefold-drapery")) || $item['product_type'] == 'newcatchall-drapery'){
        /* PPSASCRUM-305: end */
		/* PPSASCRUM-56: end */
			if($item['parent_line'] == '0' && !in_array($item['line_number'],$parents)){
				$parents[]=$item['line_number'];
...
if(in_array('swtmisc',$types) && (in_array('track',$types) ) ){
	echo "<br pagebreak=\"true\"/>";
}
...
if(in_array('track',$types) && in_array('catchall',$types) ){
	echo "<br pagebreak=\"true\"/>";
}
...
//CATCH-ALL BEGIN
	...
	<thead>
	<tr bgcolor=\"#111111\">
		<th width=\"4%\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>LINE</b></span></th>
		<th width=\"7%\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:5px;line-height:400%;\"><span style=\"font-size:5px;color:#FFFFFF;\"><b>LOCATION</b></span></th>
	...
	foreach($quoteItems as $itemid => $item){
		...
		if(!in_array($itemid,$usedLines)){
			if($item['product_type'] == 'custom' && $item['parent_line'] == 0){
				...
				echo "<tr bgcolor=\"".$bgcolor."\">";
				echo "<td width=\"4%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['line_number']."</span></td>";
				echo "<td width=\"7%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['room_number']."</span></td>";
				...
				echo "<td width=\"15%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['title']."</span></td>";
				echo "<td width=\"15%\" style=\"font-size:7px;\"><span style=\"font-size:7px;color:#000000;\">".$item['description'];
