...
if(intval($quoteID) >0){
	...
	if($isEdit){
		...
		echo $this->Form->button('Save Changes',['type'=>'submit','onClick'=>'return canCalculate();']); //PPSAsCRUM-90
	}else{
		//echo $this->Form->button('Add To Quote',['type'=>'submit']);
		echo $this->Form->button('Add To Quote',['type'=>'submit','onClick'=>'return canCalculate();']); //PPSASCRUM-90
...
$(function(){
    ...
    $('input[name=hingecount]').change(function() {
        if ($('#hinged').is(":checked")) {  
            if ($(this).val() < 1) {
                $(this).removeClass('notvalid').removeClass('validated').addClass('notvalid');
                $(this).parent().addClass('badvalue');
                ...
                $(this).removeClass('notvalid').removeClass('validated').addClass('validated');
                $(this).parent().removeClass('badvalue');
