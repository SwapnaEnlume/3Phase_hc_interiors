...
//PPSASCRUM-141 start
echo "<select name=\"linings_id\" id=\"linings_id\"><option value=\"\" data-price=\"0.00\">--Select Lining--</option><option value=\"none\" data-price=\"0.00\"";
	if($thisItemMeta['linings_id'] == "none")
...
function doCalculation(){
	...
	<?php
		...
		*/
		...
		/*PPSASCRUM-142: start*/
		var liningCst = roundToTwo(liningCost).toFixed(2);
