...
if($mode=='edit'){
   $typeTitle = ($ordermode == 'workorder') ? "WorkOrder ": ($ordermode == 'workorder') ? "SalesOrder " : " ";
    ...
    echo "<h3>Edit ".$typeTitle."Bedding Catch-All Line Item</h3><hr>";
}else{
...
<td width=\"50%\" valign=\"top\" style=\"padding:15px;\">
    ...
    /* PPSASCRUM-400: start */
    echo $this->Form->input('width',['type'=>'number','min'=>'0', 'step' => 0.25,'value'=>$widthval,'label'=>'FINISHED WIDTH', 'required'=>true]);
    /* PPSASCRUM-400: end */
    ...
    /* PPSASCRUM-400: start */
    echo $this->Form->input('length',['type'=>'number','min'=>'0', 'step' => 0.25,'value'=>$lengthval,'label'=>'FINISHED LENGTH','required'=>true]);
    /* PPSASCRUM-400: end */
