...
switch($thisLineItem['lineitemtype']){
	case "simple":
		...
		echo "<h3>Edit Price List Line Item</h3><hr>";
		...
		echo "<p><label for=\"location\">Location</label> <input type=\"text\" name=\"location\" id=\"location\" value=\"".$thisLineItem['room_number']."\" /></p>";

		echo "<div id=\"databox\"></div>";
		
		
		if($thisLineItem['product_type'] == 'track_systems'){
			echo "<p id=\"qtyline\"><b></b> <input type=\"number\" id=\"qtyvalue\" value=\"".$thisLineItem['qty']."\" min=\"1\" /> <button id=\"addsimpleproducttoquote\">Save Changes</button></p>";
		...
		function setproducttype(){
			if($('#product').val() != '0'){
					...
					$.get('/quotes/getproductselectlist/'+$('#product').val()+'/fromedit/".$thisLineItem['id']."/',function(data){
...
";
	...
	echo "
		...
		if($thisLineItem['product_type'] == 'cubicle_curtains'){
			...
			echo "editquotebs/".$quoteID."/".$thisLineItem['id']."/'+$('#fabricid').val()+'/'+$('#fabricidwithcolor').val()+'/'+$('select#bssize option:selected').attr('data-bsid')+'/'+$('#sizeid').val()+'/'+$('#qtyvalue').val()+'/'+$('#price').val()+'/'+$('#weight').val()+'/'+$('#difficulty').val()+'/'+$('#yards').val()+'/'+isquilted+'/'+$('#mattresssize').val()+'/'+$('#topwidthsl').val()+'/'+$('#dropwidthsl').val()+'/'+$('#quiltpattern').val()+'/'+$('#topcutsw').val()+'/'+$('#dropcutsw').val()+'/'+$('#repeat').val()+'/'+usealiasyesno+'/'+specialpricingyesno+'/'+$('#layout').val()+'/'+$('#location').val()";
			
		}elseif($thisLineItem['product_type'] == 'services'){
			echo "editquoteservice/".$quoteID."/'+$('#serviceid').val()+'/'+$('#priceinput').val()+'/'+$('#qtyvalue').val()+'/'+$('#location').val()";

		}elseif($thisLineItem['product_type'] == 'window_treatments'){
			
			echo "editquotewt/".$quoteID."/".$thisLineItem['id']."/'+$('#wttype').val()+'/'+$('#fabricid').val()+'/'+$('#fabricidwithcolor').val()+'/'+$('#wtid').val()+'/'+$('#sizeid').val()+'/'+$('#qtyvalue').val()+'/'+$('#price').val()+'/'+$('#weight').val()+'/'+$('#difficulty').val()+'/'+$('#yards').val()+'/'+$('#haswelts').val()+'/'+$('#liningoption').val()+'/'+$('#pairorpanel').val()+'/'+$('#labor-lf').val()+'/'+$('#specialpricing').val()+'/no/'+usealiasyesno+'/'+shortpointval+'/'+$('#location').val()";
			...
			//addtracktoquote($quoteID,$trackItemID,$qty,$price)
				/**PPSASCRUM-27 start **/
			echo "editquotetrack/".$thisLineItem['id']."/".$quoteID."/'+$('select[name=system_id]').val()+'/'+$('#qtyvalue').val()+'/'+$('select[name=system_id] option:selected').attr('data-price')+'/'+escapeTextFieldforURL($('#description').val())+'/'+escapeTextFieldforURL($('#location').val())";
			/**PPSASCRUM-27 end **/
		}
	...
	case "custom":
		...
		if($lineitemdata['product_type'] == 'track_systems'){
			...
			echo $this->Form->input('price',['label'=>'Price Per Unit','required'=>true,'value'=>$lineitemmeta['price']]);
