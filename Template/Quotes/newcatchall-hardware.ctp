...
if($mode=='edit'){
    ...
    echo "<h3>Edit ". $typeTitle. " Hardware Catch-All Line Item</h3><hr>";
}else{
...
foreach($fabrics as $fabric) {
    ...
    echo "
        ...
        if($mode=='edit' && $lineitemmeta['fabrictype'] == 'existing' && $fabric['fabric_name'] == $lineitemmeta['fabric_name'] && $vendorId == $lineitemmeta['vendors_id']){
...
echo "</td>"; */
echo "<td width=\"50%\" valign=\"top\"><label>Vendor</label>";
