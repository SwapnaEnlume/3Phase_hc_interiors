...
switch($thisLineItem['lineitemtype']){
	case "simple":
		...
		if($thisLineItem['product_type'] == 'track_systems'){
			...
			echo "<p id=\"qtyline\"><b></b> <input type=\"number\" id=\"qtyvalue\" value=\"".$thisLineItem['qty']."\" min=\"1\" readonly =\"true\"/> <button id=\"addsimpleproducttoquote\">Save Changes</button></p>";
			else 
...
";
	...
	echo "
		...
		if($thisLineItem['product_type'] == 'cubicle_curtains'){
			...
			echo "editquotebs/".$quoteID."/".$thisLineItem['id']."/'"."+$('#ordermode').val()+'/'+$('#fabricid').val()+'/'+$('#fabricidwithcolor').val()+'/'+$('select#bssize option:selected').attr('data-bsid')+'/'+$('#sizeid').val()+'/'+$('#qtyvalue').val()+'/'+$('#price').val()+'/'+$('#weight').val()+'/'+$('#difficulty').val()+'/'+$('#yards').val()+'/'+isquilted+'/'+$('#mattresssize').val()+'/'+$('#topwidthsl').val()+'/'+$('#dropwidthsl').val()+'/'+$('#quiltpattern').val()+'/'+$('#topcutsw').val()+'/'+$('#dropcutsw').val()+'/'+$('#repeat').val()+'/'+usealiasyesno+'/'+specialpricingyesno+'/'+($('#layout').val().length > 0) ?$('#layout').val().length : 1.33 +'/ '+$('#location').val()+'/'+$('#ordermode').val()";
			
		}elseif($thisLineItem['product_type'] == 'services'){
			echo "editquoteservice/".$quoteID."/'+$('#serviceid').val()+'/'+$('#priceinput').val()+'/'+$('#qtyvalue').val()+'/'+$('#location').val()+'/'+$('#ordermode').val()" ;
