...
if($ordermode == "workorder" && isset($thisLineItem['best_price'])) 
	echo $this->Form->input('price',['label'=>'Price Per Unit','readonly'=>true,'value'=>$thisLineItem['best_price']]);
else 
	echo $this->Form->input('price',['label'=>'Price Per Unit','required'=>true,'value'=>$thisLineItem['best_price']]);
