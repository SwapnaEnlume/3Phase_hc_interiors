...
if($mode=='edit'){
    ...
    echo "<h3>Edit ".$typeTitle. " HWT Miscellaneous Catch-All Line Item</h3>";
}else{
    echo "<h3>Add HWT Miscellaneous Catch-All Line to Quote</h3>";
}
...
echo "<fieldset id=\"shuttersfields\"><legend>Inputs</legend>";
    ...
    if($mode=='edit'){
        if($lineitemmeta['hwtmisc-mount'] == 'in'){
            echo " checked=\"checked\"";
        }
    }
    echo " name=\"hwtmisc-mount\" value=\"in\" id=\"hwtmiscmountin\" /> IN</label></td>
    <td width=\"33%\"><label><input type=\"radio\"";
    if($mode=='edit'){
        if($lineitemmeta['hwtmisc-mount'] == 'out'){
            echo " checked=\"checked\"";
        }
    }
    echo " name=\"hwtmisc-mount\" value=\"out\" id=\"hwtmiscmountout\" /> OUT</label></td>
    </tr>
    <tr id=\"inputdrawtypefield\">
    <td width=\"34%\">Draw/Type</td>
    <td width=\"66%\" colspan=\"2\"><textarea name=\"draw-type\" cols=\"50\" rows=\"4\">";
    if($mode=='edit'){
        echo $lineitemmeta['draw-type'];
    }
    echo "</textarea></td>
    </tr>
    <tr id=\"inputmounttypefield\">
    <td width=\"34%\">Mount Type</td>
    <td width=\"66%\" colspan=\"2\"><input type=\"text\" name=\"mount-type\"";
    if($mode=='edit'){
        echo " value=\"".$lineitemmeta['mount-type']."\"";
    }
    echo " /></td>
    </tr>
    ...
    <td width=\"33%\"><label><input type=\"radio\"";
    if($mode=='edit'){
        if($lineitemmeta['hwtmisc-valance'] == 'yes'){
            echo " checked=\"checked\"";
        }
    }
    echo " name=\"hwtmisc-valance\" value=\"yes\" id=\"hwtmiscvalanceyes\" /> Yes</label></td>
    <td width=\"33%\"><label><input type=\"radio\"";
    if($mode=='edit'){
        if($lineitemmeta['hwtmisc-valance'] == 'no'){
            echo " checked=\"checked\"";
        }
    }
    echo " name=\"hwtmisc-valance\" value=\"no\" id=\"hwtmiscvalanceno\"  /> No</label></td>
    </tr>
    </table>";
...
function checkSubmittable(){
    ...
    */
    ...
    if(!$('#hwtmiscmountin').prop('checked') && !$('#hwtmiscmountout').prop('checked')){
        missingCount++;
        $('tr#inputmountfield').addClass('stillneeded');
        $('fieldset#hwtmiscfields').addClass('stillneeded');
        inputsMissing++;
    }else{
        $('tr#inputmountfield').removeClass('stillneeded');
    }
    
    if(!$('#hwtmiscvalanceyes').prop('checked') && !$('#hwtmiscvalanceno').prop('checked')){
        missingCount++;
    ...
    if(inputsMissing==0){
        $('fieldset#hwtmiscfields').removeClass('stillneeded');
    }
