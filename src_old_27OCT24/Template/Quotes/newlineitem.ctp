...
echo "
		...
		if(isset($subaction) && $subaction == 'cubicle-curtain'){
			...
			echo "addcctoquote/".$quoteID."/'+$('#fabricid').val()+'/'+$('#fabricidwithcolor').val()+'/'+$('#ccid').val()+'/'+$('#sizeid').val()+'/'+$('#qtyvalue').val()+'/'+$('#so_line_number option:selected').val()+'/'+parseFloat($('#priceeachvalue').html().replace('$',''))+'/'+$('#length').val()+'/'+$('#meshoption').val()+'/'+$('#weight').val()+'/'+$('#yards').val()+'/'+$('#labor-lf').val()+'/'+$('#difficulty').val()+'/'+$('#specialpricing').val()+'/'+usefinishwidthorno+'/'+usealiasyesno+'/'+escapeTextFieldforURL($('#location').val() )+'/'+'".$ordermode."'";
			...
			echo "addbstoquote/".$quoteID."/'+$('#fabricid').val()+'/'+$('#fabricidwithcolor').val()+'/'+$('select#bssize option:selected').attr('data-bsid')+'/'+$('#sizeid').val()+'/'+$('#qtyvalue').val()+'/'+$('#so_line_number option:selected').val()+'/'+$('#price').val()+'/'+$('#weight').val()+'/'+$('#difficulty').val()+'/'+$('#yards').val()+'/'+isquilted+'/'+$('#mattresssize').val()+'/'+$('#topwidthsl').val()+'/'+$('#dropwidthsl').val()+'/'+$('#quiltpattern').val()+'/'+$('#topcutsw').val()+'/'+$('#dropcutsw').val()+'/'+$('#repeat').val()+'/'+usealiasyesno+'/'+specialpricingyesno+'/'+$('#layout').val()+'/'+escapeTextFieldforURL($('#location').val() )+'/'+'".$ordermode."'";
			
			

		}elseif(isset($subaction) && $subaction == 'services'){
			echo "addservicetoquote/".$quoteID."/'+$('#serviceid').val()+'/'+$('#priceinput').val()+'/'+$('#qtyvalue').val()+'/'+$('#so_line_number option:selected').val()+'/0/0/'+escapeTextFieldforURL($('#location').val())+'/'+'".$ordermode."'";
		}elseif(isset($subaction) && $subaction=='window-treatment'){
			
			echo "addwttoquote/".$quoteID."/'+$('#wttype').val()+'/'+$('#fabricid').val()+'/'+$('#fabricidwithcolor').val()+'/'+$('#wtid').val()+'/'+$('#sizeid').val()+'/'+$('#qtyvalue').val()+'/'+$('#so_line_number option:selected').val()+'/'+$('#price').val()+'/'+$('#weight').val()+'/'+$('#difficulty').val()+'/'+$('#yards').val()+'/'+$('#haswelts').val()+'/'+$('#liningoption').val()+'/'+$('#pairorpanel').val()+'/'+$('#labor-lf').val()+'/'+$('#specialpricing').val()+'/'+$('#length').val()+'/'+usealiasyesno+'/'+shortpointval+'/'+escapeTextFieldforURL($('#location').val() )+'/'+'".$ordermode."'";
			...
			/**PPSASCRUM-27 start **///$('#so_line_number').val('');$( "#so_line_number option:selected" ).text();
           	...
           	echo "addtracktoquote/".$quoteID."/'+$('select[name=system_id]').val()+'/'+$('#qtyvalue').val()+'/'+$('#so_line_number option:selected').val()+'/'+$('select[name=system_id] option:selected').attr('data-price')+'/'+escapeTextFieldforURL($('#description').val())+'/'+escapeTextFieldforURL($('#location').val() )+'/'+$('#ordermode').val()";
			//addtracktoquote($quoteID,$trackItemID,$qty,$price)
			/**PPSASCRUM-27 end **/
		}
