...
if($item['internal_line'] == 0){
	...
	if($item['product_type'] == 'track_systems'){
		...
		echo "<td width=\"8%\" align=\"center\" style=\"border-left:1px solid #000000; border-bottom:".$bottomborder."; font-size:7px;\" valign=\"top\"><span style=\"font-size:7px;\">";
		...
		if($item['product_type']=="cubicle_curtains"){
			...
			*/
		}elseif(($item['product_type']=="window_treatments" && $item['metadata']['wttype'] == 'Pinch Pleated Drapery') || ($item['metadata']['calculator-used']=='pinch-pleated')){
		...
		if(($item['product_type'] == 'window_treatments' && $item['metadata']['wttype'] == "Pinch Pleated Drapery") || ($item['product_type']=="calculator" && $item['metadata']['calculator-used']=='pinch-pleated')){
	...
	if(count($item['notes']) >0){
		...
		foreach($item['notes'] as $noteRow){
			if($noteRow['visible_to_customer'] == '1'){
				...
				echo "<tr bgcolor=\"".$linebgcolor."\" nobr=\"true\">
				<td colspan=\"4\" align=\"right\" style=\"border-left:1px solid #000000; border-bottom:1px solid ".$bottombordercolorcode.";font-size:6px;\">".date('n/j/y g:iA',$noteRow['time'])." from ".$noteRow['name'].":</td>
