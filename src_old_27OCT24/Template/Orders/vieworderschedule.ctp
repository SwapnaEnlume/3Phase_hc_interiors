...
<div id="buttons">
	...
	<button type="button" onclick="location.href='/orders/scheduleorder/<?php echo $thisOrder[0]['id']; ?>/1'" style="float:right;">+ NEW BATCH (ANY ITEMS)</button>
	<button type="button" onclick="location.href='/orders/scheduleorder/<?php echo $thisOrder[0]['id']; ?>/0'" style="float:right;">+ NEW BATCH (MFG ITEMS)</button>
