...
echo $this->Form->input('ship_to_name',['label'=>'Ship-To Name','required'=>true]);
...
$country_list = array(
	...
	echo $this->Form->select('shipping_country',$country_list,['required'=>true,'empty'=>'--Select Country--','id'=>'shipping_country','class'=>'select','default' => 'US']);
	

echo "</div>";


echo $this->Form->button('Add This ShipTo',['type'=>'submit','style'=>"float: right;margin: 82px;margin-top: 0px;"]);
