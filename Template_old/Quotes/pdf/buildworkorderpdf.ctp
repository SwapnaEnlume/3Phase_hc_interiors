...
if(count($globalNotes) >0){
	$globalNotesOutput .= "<b>GLOBAL NOTES:</b><table width=\"1000\" style=\"background:#f8f8f8 !important; width:1000px !important;\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" bordercolor=\"#000066\">";
...
$lastparent=0;
	...
	foreach($quoteItems as $item){
		...
		if(($item['product_type'] == 'calculator' && $item['metadata']['calculator-used'] == 'straight-cornice') ||	$item['product_type'] == 'newcatchall-cornice'){
			...
			if($item['metadata']['wttype'] == 'Pinch Pleated Drapery' || $item['metadata']['calculator-used'] == 'pinch-pleated' || $item['product_type'] == 'newcatchall-drapery'){
...
$lastparent=0;
	...
	$parents=array();
	foreach($quoteItems as $item){
		if(($item['product_type'] == 'calculator' && ($item['metadata']['calculator-used'] == 'pinch-pleated' || $item['metadata']['calculator-used'] == 'pinch-pleated-new')) || $item['product_type'] == 'newcatchall-drapery'){
			if($item['parent_line'] == '0' && !in_array($item['line_number'],$parents)){
				$parents[]=$item['line_number'];
			}
		}
...
echo "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
	...
	<thead>
	<tr bgcolor=\"#111111\">
		<th width=\"5%\" valign=\"middle\" align=\"center\" style=\"vertical-align:middle; font-size:9px;\"><span style=\"font-size:9px;color:#FFFFFF;\"><b>LINE #</b></span></th>
