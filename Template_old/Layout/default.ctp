...
<head>
    ...
    if(preg_match("#orders.hcinteriors.com#i",$_SERVER['HTTP_HOST'])){
        ...
        echo "body > header{ background-color:#700101 !important; }
        header nav#topmenu ul > li{ background:#470101 !important; }
        button{ background:#470101 !important; }
        
        #welcomebar{ background:#333333 !important; color:#FFF; font-family:'metropolislight'; }
        #welcomebar a{ color:#f8f8f8; }
        
        .dataTable thead tr{ background:#700101 !important; }
        .dataTable thead tr th{ color:#FFF !important; }
        
        .dataTable tfoot tr{ background:#700101 !important; }
        .dataTable tfoot tr th{ color:#FFF !important; }
        ...
        h1.pageheading{ font-size:x-large; color:#470101; text-align:center; }
        ...
        table#quoteitems thead{ background: #700101 !important; }
        
        body:before{ content:''; width:100%; height:15px; background:#700101; position:fixed; top:0; left:0; z-index:9999; }
        ";
