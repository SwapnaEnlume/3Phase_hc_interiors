...
echo "<div id=\"tablewrap\"><table id=\"schedulebuild\" width=\"100%\" cellpadding=\"4\" cellspacing=\"0\" border=\"1\" bordercolor=\"#000000\">";

echo "<thead>
<tr style=\"border:0 !important;background:#FFF !important; color:#000 !important;\">
<th width=\"10%\" valign=\"middle\" style=\"vertical-align:middle;border:0 !important;background:#FFF !important; color:#000 !important; \">
    <img src=\"https://orders.hcinteriors.com/barcodes/genbarcode.php?value=".urlencode($orderData['order_number'])."\" style=\"width:150px; height:65px !important; \" />
</th>
<th width=\"90%\" colspan=\"6\" valign=\"middle\" style=\"vertical-align:middle;border:0 !important;background:#FFF !important; color:#000 !important;  padding-right:10% !important;\">
...
<tr>
<th width=\"10%\" rowspan=\"2\" valign=\"middle\">LINE</th>
<th width=\"10%\" rowspan=\"2\" valign=\"middle\">QTY THIS<br>BATCH</th>
...
foreach($lineItems as $itemID => $itemData){
	//if($itemData['data']['enable_tally'] == 1){
        if($itemData['this_batch'] > 0){
        	...
        	<td width=\"10%\" style=\"vertical-align:middle;\">".$itemData['data']['line_number'];
        	echo "&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"https://orders.hcinteriors.com/barcodes/genbarcode.php?value=".urlencode($itemData['data']['line_number'])."\" style=\"width:85px; height:65px !important;\" />";
        	
        	echo "</td>
        	<td width=\"15%\" class=\"thisbatch\" style=\"vertical-align:middle;\">";
        	    echo $itemData['this_batch'];
        
        	echo "</td>
        	<td width=\"10%\" style=\"vertical-align:middle;\">".$itemData['fabricdata']['fabric_name']."</td>
