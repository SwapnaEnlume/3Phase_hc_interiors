<!-- src/Template/Orders/completedschedule.ctp -->
...
<div id="tabs">
<ul>
	<li><a href="#sherryschedule">Sherry Schedule: "COMPLETED" Only</a></li>
</ul>
...
<div id="sherryschedule">
	...
	$(function(){
		...
		$('#calendar').dateRangePicker({
			...
			clearSearchHighlightRows();
			$.get('/orders/getsherryschedulerows/'+obj.date1.toISOString().substring(0, 10)+'/'+obj.date2.toISOString().substring(0, 10)+'/'+'completedschedule'+'/'+$('#highlightrowids').val(),
		...
		$.fancybox.showLoading();
	$.get('/orders/getsherryschedulerows/<?php echo date("Y-m-d"); ?>/<?php echo date("Y-m-d",(time()+604800)); ?>'+'/'+'completedschedule'+'/'+$('#highlightrowids').val(),function(responseText){
	...
	function reloadSchedule(){
		...
		//$.fancybox.showLoading();
		$.get('/orders/getsherryschedulerows/'+dateStart+'/'+dateEnd+'/'+'completedschedule'+'/'+$('#highlightrowids').val(),
			function(responseText){
				$('#scriptsoutput').html(responseText);
				//$.fancybox.hideLoading();
	...
	<thead>
		<tr>
			...
			<th class="facility" data-colnum="8" rowspan="2">Facility</th>
