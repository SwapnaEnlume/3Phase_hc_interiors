<!-- src/Template/Orders/deletesherrybatch.ctp -->

<h1>Are you sure you want to delete this Sherry Schedule Batch?</h1>
...
echo "&nbsp;&nbsp;";
echo $this->Form->button('No, Go Back',['type'=>'button', 'onclick' => 'location.replace(\'/orders/schedule/\')']);
echo "</div>";
echo $this->Form->end();
?>
<style>
