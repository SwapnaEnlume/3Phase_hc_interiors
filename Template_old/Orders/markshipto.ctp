<!-- src/Template/Products/markshipto.ctp -->
...
echo $this->Form->select('shipping_country',$country_list,['required'=>true,'empty'=>'--Select Country--','id'=>'shipping_country','style'=>' width: 98%;padding-block: 1%;','default' => 'US']);
echo "</div>";
