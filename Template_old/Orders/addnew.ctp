...
*/
    ...
    echo "<a href=\"#\" id=\"new_facility\"  style=\"display: block; height: 36px; color: white; width: 12%; text-align: center; padding: 6px 0px 0px; background: rgb(71, 1, 1) !important; float: right !important;\" id='new_facility'>+ New Recipient </a>";
                    ...
                    $(function(){
                        $('input[name=allfacility]').autocomplete({
                           ...
                           select: function(event,ui){
                               ...
                               $.get('/orders/getFacilityByName/'+encodeURIComponent(ui.item.value),function(response){
	...
	echo "</div>";
	echo $this->Form->input('facilityCode',['label'=>'Recipient Code','required'=>false,'id'=>'facilityCode']);

	echo $this->Form->input('facilityAttention',['label'=>'(Recipient)Attention','required'=>false,'id'=>'facilityAttention']);


	echo $this->Form->radio('userAddressesSelection', ['default'=>'Use Default Recipient Address','customer'=>'Use Customer Address', 'new'=>'Add a New Address','exisiting'=>'Pick an Existing Address'],['id'=>'userAddressesSelection']);
