...
/* PPSASCRUM-358: start */
echo $this->Form->input('pfas_status', ['type' => 'select', 'empty' => '--SELECT PFAS STATUS--', 'options' => $pfasStatusOptions, 'label' => 'PFAS Status']);
/* PPSASCRUM-358: end */
...
<?php 
	...
	/* PPSASCRUM-358: start */
	if(strlen($inputdata['pfas_status']) >0){
		echo "<dt>PFAS Status</dt><dd>".$pfasStatusOptions[$inputdata['pfas_status']]."</dd>";
		$otherChanges++;
	}
	/* PPSASCRUM-358: end */
