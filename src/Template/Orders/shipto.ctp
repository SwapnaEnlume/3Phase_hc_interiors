...
$(function(){
		$('#shiptoTable').dataTable({
			...
			"columns": [
				...
				{ "className":"ship_to_name","orderable": true },
                ...
                { "className":"shipping_country","orderable": false },
...
#shiptoTable th.ship_to_name, #shiptoTable td.ship_to_name{ width:15% !important; }
...
#shiptoTable th.shipping_country, #shiptoTable td.shipping_country{ width:10% !important; }
