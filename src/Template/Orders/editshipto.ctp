...
echo $this->Form->input('ship_to_name',['label'=>'Ship-To Name','required'=>true, 'value'=>$shiptoData['ship_to_name']]);
...
$country_list = array(
	...
	echo $this->Form->select('shipping_country',$country_list,['required'=>true,'empty'=>'--Select Country--','id'=>'shipping_country', 'value'=>$shiptoData['shipping_country'],'class'=>'select','default' => 'US']);
