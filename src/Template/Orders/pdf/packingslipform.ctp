<?php
	...
	<thead>
	<tr bgcolor=\"#000000\">
	<th width=\"5%\" style=\"color:#FFFFFF; font-size:6px;\" align=\"center\" valign=\"bottom\">WO Line #</th>
	<th width=\"5%\" style=\"color:#FFFFFF; font-size:6px;\" align=\"center\" valign=\"bottom\">SO Line #</th>
	<th width=\"8%\" style=\"color:#FFFFFF; font-size:6px;\" align=\"center\" valign=\"bottom\">Room #</th>
	<th width=\"5%\" style=\"color:#FFFFFF; font-size:6px;\" align=\"center\" valign=\"bottom\">QUANTITY<br>ORDERED</th>
	<th width=\"8%\" style=\"color:#FFFFFF; font-size:6px;\" align=\"center\" valign=\"bottom\">PREVIOUSLY<br>SHIPPED</th>
	...
	foreach($lineItems as $itemID => $itemData){
			if($itemData['data']['internal_line'] == 0){
				echo "<tr>
				<td width=\"5%\" style=\"font-size:7px;\" align=\"center\" valign=\"top\">".$itemData['data']['wo_line_number']."</td>
					<td width=\"5%\" style=\"font-size:7px;\" align=\"center\" valign=\"top\">".$itemData['data']['so_line_number']."</td>
				<td width=\"8%\" style=\"font-size:7px;\" align=\"left\" valign=\"top\">".$itemData['data']['room_number']."</td>
				<td width=\"5%\" style=\"font-size:7px;\" align=\"center\" valign=\"top\">".$itemData['data']['qty'];
				if($itemData['data']['unit'] == 'linear feet'){
					echo " LF";
				}
				echo "</td>
				<td width=\"8%\" style=\"font-size:7px;\" align=\"center\" valign=\"top\">&nbsp;</td>
