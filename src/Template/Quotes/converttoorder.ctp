...
*/
    ...
    echo "<a href=\"#\" id=\"new_facility\"  style=\"display: block; height: 36px; color: white; width: 21%; text-align: center; padding: 6px 0px 0px; background: rgb(71, 1, 1) !important; float: right !important;\" id='new_facility'>+ New Recipient </a>";
                        ...
                        $('input[name=default_address]').autocomplete({
                           ...
                           select: function(event,ui){
                               ...
                               //$.get('/orders/getShipAddressNameDetails/'+escapeTextFieldforURL(spiltvalue[0]),function(data){
                                ...
                                $.get('/orders/getShipAddressDetails/'+spiltvalue[6],function(data){
                                /* PPSASCRUM-362: end */
                            				const myArray2 = data.split(' :|: ')
