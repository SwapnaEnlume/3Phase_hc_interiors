...
echo $this->Form->input('imagefileupload',['label'=>'Image File','type'=>'file','accept'=>'image/jpeg,image/png,image/gif']);
/*PPSASCRUM-185: end*/
...
#imagelibrarycontents{ width:99%; height:310px; background:#FFF; padding:5px; overflow-y:scroll; overflow-x:none; }
