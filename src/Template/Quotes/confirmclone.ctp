...
echo $this->Form->submit('Yes, Clone Now',['onClick' => 'this.disabled=true;this.form.submit();return true;']); //PPSASCRUM-231 change
echo "&nbsp;&nbsp;";
echo $this->Form->button('No, Go Back',['type'=>'button', 'onclick' => 'this.disabled=true;history.go(-1)']);
echo "</div>";
echo $this->Form->end();
?>
<style>
