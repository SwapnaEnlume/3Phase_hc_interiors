...
if($mode=='edit'){
    ...
    echo "<h3>Edit ".$typeTitle."  SWT Miscellaneous Catch-All Line Item</h3>";
}else{
...
if(($mode=='edit' || $mode=='workorderedit' || $ordermode =='workorder') && $lineitemmeta['fabrictype'] == 'none'){
...
// /* PPSASCRUM-100: end */
// if($ordermode == 'workorder' && isset($thisLineItem['fabricname'])) {
//     echo "diabled=\"true\"";
// }else echo ">";
...
function checkSubmittable(){
   ...
   if ($('#com-fabric').prop('checked')) {
    ...
    //if all complete, enable the Add To Quote button
    console.log('beforeconditon check');
