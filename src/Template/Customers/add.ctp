...
<?= $this->Form->create($customer) ?>
   ...
   <fieldset>
		...
		<?php
		 /**PPSASCRUM-7 Start **/	
	    echo $this->Form->input('shipping_name',['autocomplete'=>'off']);
	    /**PPSASCRUM-7 end **/
	...
	<?php  /**PPSASCRUM-85 Start **/ ?>
	<fieldset>
   		<legend>Customer Specific Notes</legend>
		<?php
	       	
	    echo $this->Form->input('customer_notes',['autocomplete'=>'off']);
	  
		echo $this->Form->input('pricing_programs',['autocomplete'=>'off']);
		?>
	</fieldset>
	 <?php  /**PPSASCRUM-85 end **/ ?>
