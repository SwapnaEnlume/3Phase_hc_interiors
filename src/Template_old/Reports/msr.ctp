			...
			"drawCallback": function( settings ) {
		        ...
		        $('#msrTable td.notes').dblclick(function(){
		            ...
		            $('tr#'+thisid+' td.notes input[type=text]').keyup($.debounce( 650, function(){
                		...
                		$.ajax({
                            url: '/reports/msr/updatefield/'+thisid+'/notes/'+$('tr#'+thisid+' td.notes input[type=text]').val()+'/nolog',
                            method:'GET'
                        });
			...
			"drawCallback": function( settings ) {
		        ...
		        $('#closedmsrTable td.notes').dblclick(function(){
		            ...
		            $('#closedmsrTable tr#'+thisid+' td.notes input[type=text]').keyup($.debounce( 650, function(){
                		...
                		$.ajax({
                            url: '/reports/msr/updatefield/'+thisid+'/notes/'+$('#closedmsrTable tr#'+thisid+' td.notes input[type=text]').val()+'/nolog',
                            method:'GET'
                        });
...
function changeOrderStatus(newval,field,rowid){
    $.ajax({
        url: '/reports/msr/updatefield/'+rowid+'/'+field+'/'+newval,
