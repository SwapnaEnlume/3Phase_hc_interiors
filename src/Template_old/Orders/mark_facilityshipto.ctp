...
echo "<h2 style=\"float:left;\">Create New ShipTo Address</h2>
<hr style=\"clear:both;\" />";
...
echo "<div class=\"input selectbox required\"><label style='display: block;font-weight: bold;'>Ship-To Country</label>";
